...
def build():
    ...
    egg_info_dir = os.path.join(os.path.dirname(os.path.dirname(__file__)),
                                "{{ cookiecutter.project_slug }}.egg-info")
...
def flake8():
    ...
    subprocess.check_call(["flake8", "{{ cookiecutter.project_slug }}"])
    click.echo("Done.")
...
def install():
    ...
    click.echo("Installing {{ cookiecutter.project_slug }}...")
...
def install_reqs():
    ...
    click.echo(
        "Installing requirements for {{ cookiecutter.project_slug }}..."
    )
